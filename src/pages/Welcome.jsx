...
function Welcome() {
    ...
    return (
        <div className="h-screen flex flex-col items-center font-sans variantfill-four">
            ...
            <div className='w-full h-full flex flex-col my-14 items-center gap-10'>
                ...
                {user && (
                    <Link to="/IdeasStudio" className='w-2/3 md:w-1/2 lg:w-2/5 h-1/5 md:h-1/3 flex justify-center items-center'>
                        <DefaultButton className="w-full h-full">
